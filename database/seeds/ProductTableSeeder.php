    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 30; $i++) {
            Product::create([
                ...
                'slug' => 'laptop-' . $i,
                'featured'=>true,
                'image'=>"products\\December2018\\laptop-{$i}.jpg",
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'slug' => 'desktop-' . $i,
                'featured'=>true,
                'image'=>"products\\December2018\\desktop-{$i}.jpg",
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'slug' => 'phone-' . $i,
                'featured'=>true,
                'image'=>"products\\December2018\\phone-{$i}.jpg",
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'slug' => 'tablet-' . $i,
                'featured'=>true,
                'image'=>"products\\December2018\\tablet-{$i}.jpg",
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'slug' => 'tv-' . $i,
                'featured'=>true,
                'image'=>"products\\December2018\\tv-{$i}.jpg",
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'slug' => 'camera-' . $i,
                'featured'=>false,
                'image'=>"products\\December2018\\camera-{$i}.jpg",
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'slug' => 'appliance-' . $i,
                'featured'=>true,
                'image'=>"products\\December2018\\appliance-{$i}.jpg",
